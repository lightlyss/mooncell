(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Seraph = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
...
},{"is-promise":1,"lodash":2}],4:[function(require,module,exports){
  ...
  var _loop = function _loop() {
    ...
    Object.keys(node).forEach(function (k) {
      if (k === LEAF) {
        ...
        withinDistance(query, k, maxDistance - distance, i, edit).forEach(function (_ref3) {
...
var withinDistance = function withinDistance(a, b, maxDistance, i, edit) {
  var stack = [{
    distance: 0,
    ia: i,
    ib: 0,
  ...
  while (stack.length > 0) {
    ...
    if (mem[ia][ib] && mem[ia][ib] <= distance) {
      continue;
    }
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { MiniSearch_defineProperty(target, key, source[key]); }); } return target; }
  ...
  MiniSearch_createClass(MiniSearch, [{
    ...
    */
    ...
    value: function remove(document) {
      ...
      var _ref = Object.entries(this._documentIds).find(function (_ref3) {
        var _ref4 = MiniSearch_slicedToArray(_ref3, 2),
            _ = _ref4[0],
            longId = _ref4[1];

        return document[idField] === longId;
      }) || [],
          _ref2 = MiniSearch_slicedToArray(_ref, 1),
      ...
      fields.filter(function (field) {
        ...
        tokenize(document[field]).forEach(function (term) {
          ...
          if (isTruthy(processedTerm)) {
            removeTerm(_this3, _this3._fieldIds[field], shortDocumentId, processTerm(term));
          }
        });
      });
    ...
    */
    ...
    value: function search(queryString) {
      ...
      var results = queries.map(function (query) {
        return _this4.executeQuery(query, options);
      });
      var combinedResults = this.combineResults(results, options.combineWith);
      return Object.entries(combinedResults).map(function (_ref5) {
        var _ref6 = MiniSearch_slicedToArray(_ref5, 2),
            docId = _ref6[0],
            _ref6$ = _ref6[1],
            score = _ref6$.score,
            match = _ref6$.match,
    ...
    */
    ...
    value: function autoSuggest(queryString) {
      ...
      var suggestions = this.search(queryString, options).reduce(function (suggestions, _ref9) {
      ...
      return Object.entries(suggestions).map(function (_ref10) {
        var _ref11 = MiniSearch_slicedToArray(_ref10, 2),
            suggestion = _ref11[0],
            _ref11$ = _ref11[1],
            score = _ref11$.score,
            terms = _ref11$.terms,
    ...
    value: function executeQuery(query) {
      ...
      if (query.prefix) {
        this._index.atPrefix(query.term).forEach(function (term, data) {
          ...
          results.push(termResults(_this5, term, boosts, boostDocument, data, prefixWeight, weightedDistance));
        });
      }

      if (query.fuzzy) {
        var maxDistance = query.fuzzy < 1 ? Math.round(query.term.length * query.fuzzy) : query.fuzzy;
        Object.entries(this._index.fuzzyGet(query.term, maxDistance)).forEach(function (_ref14) {
          var _ref15 = MiniSearch_slicedToArray(_ref14, 2),
              term = _ref15[0],
              _ref15$ = MiniSearch_slicedToArray(_ref15[1], 2),
              data = _ref15$[0],
              distance = _ref15$[1];

          var weightedDistance = distance / term.length;
          results.push(termResults(_this5, term, boosts, boostDocument, data, fuzzyWeight, weightedDistance));
        });
      }
...
var warnDocumentChanged = function warnDocumentChanged(self, shortDocumentId, fieldId, term) {
  ...
  var fieldName = Object.entries(self._fieldIds).find(function (_ref16) {
    var _ref17 = MiniSearch_slicedToArray(_ref16, 2),
        name = _ref17[0],
        id = _ref17[1];
...
var termResults = function termResults(self, term, boosts, boostDocument, indexData) {
  ...
  return Object.entries(boosts).reduce(function (results, _ref18) {
    var _ref19 = MiniSearch_slicedToArray(_ref18, 2),
        field = _ref19[0],
        boost = _ref19[1];

    var fieldId = self._fieldIds[field];

    var _ref20 = indexData[fieldId] || {
      ds: {}
    },
        df = _ref20.df,
        ds = _ref20.ds;

    Object.entries(ds).forEach(function (_ref21) {
      var _ref22 = MiniSearch_slicedToArray(_ref21, 2),
          documentId = _ref22[0],
          tf = _ref22[1];
...
var combinators = (_combinators = {}, MiniSearch_defineProperty(_combinators, OR, function (a, b) {
  return Object.entries(b).reduce(function (combined, _ref23) {
    var _ref24 = MiniSearch_slicedToArray(_ref23, 2),
        documentId = _ref24[0],
        _ref24$ = _ref24[1],
        score = _ref24$.score,
        match = _ref24$.match,
  ...
  return Object.entries(b).reduce(function (combined, _ref25) {
    var _ref26 = MiniSearch_slicedToArray(_ref25, 2),
        documentId = _ref26[0],
        _ref26$ = _ref26[1],
        score = _ref26$.score,
        match = _ref26$.match,
...
var defaultOptions = {
  ...
  tokenize: function tokenize(string, _fieldName) {
    return string.split(/[^a-zA-Z0-9\u00C0-\u017F]+/);
  },
  processTerm: function processTerm(term, _fieldName) {
    return term.length > 1 && term.toLowerCase();
  },
  fields: undefined,
  searchOptions: undefined
};
